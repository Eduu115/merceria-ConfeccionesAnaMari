  ...
  return (
    <>
      <section className="grid md:min-h-[420px] md:grid-cols-2">
        <div className="order-2 flex flex-col justify-center bg-crema px-4 py-10 md:order-1 md:px-10 lg:px-14">
          <div className="mx-auto w-full max-w-xl">
            <h1 className="font-titular text-[2.15rem] font-semibold leading-[1.12] text-tinta md:text-[2.6rem] lg:text-[2.85rem]">
              {a.inicio_titular}
            </h1>
        ...
        <div className="order-1 min-h-[220px] md:order-2 md:min-h-[420px]">
          <MarcadorSinFoto
            variante="bloque"
            etiqueta="Foto: máquina de coser / manos trabajando"
            className="h-56 min-h-[220px] md:h-full md:min-h-[420px]"
          />
        </div>
      </section>
      ...
      <section className="border-y border-borde">
        <div className="envoltorio py-12 md:py-16">
          <h2 className="mb-6 font-titular text-[1.85rem] text-tinta md:text-[2.15rem]">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4 lg:gap-4">
            {data.categorias.map((c) => (
              ...
              >
                ...
                <div className="p-3">
                  <h3 className="font-cuerpo text-[0.95rem] font-semibold text-tinta">{c.nombre}</h3>
      ...
      <section className="grid md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="bg-arena px-4 py-10 md:px-10 lg:px-12">
          <h2 className="font-titular text-[2rem] leading-[1.15] text-tinta md:text-[2.35rem]">
      ...
      <section className="border-b border-borde">
        <div className="envoltorio py-12 md:py-16">
          <div className="mb-6 flex items-baseline justify-between gap-4">
            <h2 className="font-titular text-[1.85rem] text-tinta md:text-[2.15rem]">
      ...
      <section className="grid items-center border-b border-borde bg-crema md:grid-cols-2">
        ...
        <div className="order-1 p-4 md:order-2 md:p-6">
          <MarcadorSinFoto
            ...
            className="h-56 min-h-[220px] border border-dashed border-borde-fuerte md:h-[280px]"
          />
        </div>
      </section>

      <section className="grid md:grid-cols-2">
        <h2 className="envoltorio pt-10 font-titular text-[1.85rem] text-tinta md:hidden">
          {copys.inicio.donde}
        </h2>
        <div className="min-h-[200px] bg-arena-2 md:min-h-[280px]">
          <Mapa
        ...
        <div className="flex flex-col justify-center px-4 py-10 md:px-10">
          <div className="mx-auto flex w-full max-w-xl flex-col">
            <h2 className="hidden font-titular text-[2rem] leading-[1.15] text-tinta md:block md:text-[2.35rem]">
              {copys.inicio.donde}
            </h2>
