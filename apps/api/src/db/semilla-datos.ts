...
export const CATEGORIAS = [
  ...
  },
  {
    ...
    tipo: 'ropa' as const,
    descripcion: 'Prendas de diario, con talla amplia y trato de mostrador.',
    orden: 2,
  },
  {
...
export const ROPA: RopaSemilla[] = [
  ...
  {
    slug: 'sujetador-copa-suave',
    nombre: 'Sujetador de copa suave',
    categoria: 'ropa-interior',
    descripcion: 'Sujetador sin aros, copa suave. Tallas amplias; pregunta en tienda.',
    composicion: 'Algodón y elastano',
    colores: 'Blanco, nude, negro',
    destacado: true,
  },
  {
    slug: 'braga-algodon',
    nombre: 'Braga de algodón',
    categoria: 'ropa-interior',
    descripcion: 'Braga de algodón de corte clásico. Se vende suelta.',
    composicion: '100 % algodón',
    colores: 'Blanco, negro, surtido',
  },
  {
    slug: 'camiseta-interior-tirantes',
    nombre: 'Camiseta interior de tirantes',
    categoria: 'ropa-interior',
    descripcion: 'Camiseta interior de tirantes, tejido de punto fino.',
    composicion: '100 % algodón',
    colores: 'Blanco, crudo',
  },
  {
    slug: 'pack-bragas',
    nombre: 'Pack de bragas de algodón',
    categoria: 'ropa-interior',
    descripcion: 'Pack de tres bragas de algodón. Colores surtidos.',
    composicion: '100 % algodón',
    colores: 'Surtido',
    agotado: true,
  },
